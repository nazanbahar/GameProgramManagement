...
namespace MernisServiceReference
{
    ...
    public partial class TCKimlikNoDogrulaRequestBody
    {
        ...
        public TCKimlikNoDogrulaRequestBody(long nationalityId, string firstName, string lastName, DateTime dateOfBirthYear) : this(nationalityId)
        {
            FirstName = firstName;
            LastName = lastName;
        ...
        public DateTime DateOfBirthYear { get; }
    }
